...
export default function BusinessEconomyKPIStrip() {
  return (
    <div className="grid grid-cols-5 gap-3">
      {businessEconomyKPIs.map((item) => (
        <div
          key={item.label}
        ...
        >
          <div className="p-3">
            ...
            <p className="mt-1 font-black leading-none" style={{ fontSize: "1.85rem", color: "#1B2A4A" }}>
              {item.value}
              <span className="ml-1 text-sm font-bold">{item.unit}</span>
            </p>
